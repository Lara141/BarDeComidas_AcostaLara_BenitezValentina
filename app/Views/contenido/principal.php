...
<ul class="nav nav-pills justify-content-center mb-4 flex-wrap" id="pills-tab" role="tablist">
  <?php $i = 0; foreach ($provincias as $slug => $nombre): ?>
    <li class="nav-item" role="presentation">
      <a class="nav-link <?= (isset($_GET['provincia']) && $_GET['provincia'] === $nombre) || (!isset($_GET['provincia']) && $i === 0) ? 'active' : '' ?>"
         href="<?= base_url('principal?provincia=' . urlencode($nombre)); ?>">
        <?= $nombre ?>
      </a>
    </li>
  <?php $i++; endforeach; ?>
...
<!-- Contenido de la provincia seleccionada -->
