...
<section id="nosotros" style="margin-top: 40px; padding: 20px;">
  <h2 class="text-center mb-4">Conocé más sobre nosotros</h2>
  ...
  <div class="accordion accordion-flush" id="accordionFlushExample">
      ...
      <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
        <div class="accordion-body">
          <p class="mb-4 text-center">
            Contamos con un equipo comprometido, compuesto por chefs, mozos, encargados de salón, personal de limpieza y administración.  
            A continuación, te presentamos a algunos de los miembros más destacados que hacen posible nuestra experiencia única.
          </p>
          <div class="row text-center">
          <div class="col-md-4 mb-4">
              <img src="assets/Img/dueñas.jpg" class="rounded-circle img-fluid mb-2" style="max-width: 150px;" alt="Fundadora">
              <h5>Acosta Lara - Benitez Valentina</h5>
              <p>Socias, fundadoras del establecimiento</p>
            </div>
            <div class="col-md-4 mb-4">
              <img src="assets/Img/chef.jpg" class="rounded-circle img-fluid mb-2" style="max-width: 150px;" alt="Chef">
              <h5>Aymara Botana</h5>
              <p>Chef Principal</p>
            </div>
            <div class="col-md-4 mb-4">
              <img src="assets/Img/chef2.jpg" class="rounded-circle img-fluid mb-2" style="max-width: 150px;" alt="Chef">
              <h5>Sebastian Rojas</h5>
              <p>Chef</p>
            </div>
            <div class="col-md-4 mb-4">
              <img src="assets/Img/enc.jpg" class="rounded-circle img-fluid mb-2" style="max-width: 150px;" alt="Encargado">
              <h5>Tomás Gómez</h5>
              <p>Encargado</p>
            </div>
            <div class="col-md-4 mb-4">
              <img src="assets/Img/barman.jpg" class="rounded-circle img-fluid mb-2" style="max-width: 150px;" alt="Barman">
              <h5>Ricardo Monzón</h5>
              <p>Barman</p>
            </div>
            <div class="col-md-4 mb-4">
              <img src="assets/Img/moza.jpg" class="rounded-circle img-fluid mb-2" style="max-width: 150px;" alt="Moza">
              <h5>Maria Vallejos</h5>
              <p>Moza</p>
            </div>
          </div>
        </div>
    ...
    <!-- VALORES DE LA EMPRESA (todavia en duda si dejamos)-->
    <div class="accordion-item">
      <h2 class="accordion-header">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
      ...
      <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
        <div class="accordion-body">
          <ul>
            <li><strong>Pasión por la cocina:</strong> cocinamos con amor, como en casa.</li>
