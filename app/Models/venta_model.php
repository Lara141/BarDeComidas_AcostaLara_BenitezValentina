...
class Venta_Model extends Model
{
    ...
    protected $allowedFields = ['id_persona', 'fecha_venta', 'total_venta', 'activo'];//campos que se pueden insertar o actualizar en la base de datos (los mismos nombres que estan en la base de datos deben estar aca, excepto el que tiene la llavesita osea el id)
