...
class Ventas_controller extends BaseController
{
    ...
    public function listar_ventas()
    {
        ...
        $builder->select('ventas.id_venta, persona.nombre_persona, ventas.metodo_entrega, ventas.direccion_entrega, ventas.fecha_venta, ventas.total_venta, COUNT(detalle_venta.id_detalle_venta) as cantidad_productos');
